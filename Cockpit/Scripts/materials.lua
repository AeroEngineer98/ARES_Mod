print_message_to_user("HUD materials.lua started")
...
local IndicationTexturesPath = LockOn_Options.script_path.."../Textures/a4e_cockpit_glass_radar"
...
print_message_to_user("HUD materials.lua finished")
